...
Two floors: W_n=q_n‖q_nα‖≈1/a_{n+1} — miss IS the future. Descent-end: CF dps≈1.7n; COUNT≈ln n; MAX÷n med 1/ln²2. maxquotient-law.py. Transfer op: (L_s f)(r)=Σ_a (1/(a+r))^{2s}f(1/(a+r)); s=1 GK. gkw-spectrum.py, two-ones-dim.py. Heard: drone mid, where pure-side, mono cancels. Weight-s (gkw-weight-crossing.py): converges Re s>1/2; λ₁=1@s=1 pole, λ₂→−1@s=1/2 shore — crit line = the boundary; λ₂+1≈4(s−1/2). Ladder TRUE: +1, −.303663, +.100885, −.035496…; signs alternate=THEOREM (osc op, n−1 zeros); ratios .304→.374→1/φ²=.382 (Flajolet–Vallée). Chebyshev spectral (gkw-spectral.py); fails λ₄+.
