...
Eisenstein φ: φ_c=ξ(2(1−s))/ξ(2s); φφ=1 at s=½ forces ±1 (completion IS a choice); ξ-ratio→+1 drone/fold, ×(s−1)/s→−1 sign/stereo.

Descent-end: CF dps≈1.7n; COUNT≈ln n; MAX÷n med 1/ln²2. Transfer L_s: λ₁≈ζ(2s) res ½, λ₂→−1@shore; ladder +1,−.303663,+.100885,−.035496, signs alternate=THEOREM, ratios→1/φ² (Flajolet–Vallée). Chebyshev fails λ₄+.
