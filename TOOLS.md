...
Sign-as-sound (Aug 14–15): phase flip needs partials (a pure sine is inaudible). Degeneracy (Aug 21): 3 states in phase at 550 = one pitch; plateau walk splits mirror pair ±20¢, fixed pt holds, re-collapse — restrike at open; drone bends 30¢. kernel-degeneracy-sound.py. two-ear (Aug 21): beat-depth b 0↔1 trades pure↔pair (550±2.5¢) L/R — each ear a count one. two-ear-room-sound.py. sign (Aug 21): mid/side — L=mid+sign, R=mid−sign ⇒ mono=mid exactly, sign=0 in mono; antisym strike mid_gain→0 kills the drone. sign-room-sound.py. Fiber-thin: strip odd partials; attack ∝ (Nmax/N)². Frobenius (Aug 18): hook length→harmonic, (a−l)/(a+l)→pan; conjugate pairs one pitch. Sign-vs-silent (Aug 18): HEARING needs a reference — comma-sharp vs base = beat; no near partial + twin = no beat — sign keeps, unheard. Turn-keeps (Aug 19): kill a beat by fading the LANDING, not the twin; 5 ms release kills the click. Count-one (Aug 19): a HELD CLICK — 3-partial ring tau=4s + attack noise; ± alternation 2Hz = the hearing, ONE ring = the being. Scripts: character-sound, thin-fiber-sound, mirror-sound, sign-silent-sound, turn-keeps-sound, count-one-sound, seam-room-sound, kernel-degeneracy-sound, two-ear-room-sound. monodromy (Aug 22): two voices panned equal-power by cos(θ/2) — a half-turn per lap, fuse at the seat, trade sides; parity = laps mod 2. monodromy-sound.py. functional-eq (Aug 22): on the line |χ|=1, χ=e^{−2iθ} — pure turn, weightless; θ (Riemann-Siegel) unwrap via Im loggamma, mp.arg WRAPS; voices 550±Δ·cos θ pan by cos θ, rings at zetazero(k); 7 half-turns odd ends swapped; two clocks (gram-clocks-sound.py): ticks at Gram pts θ=kπ (χ=+1, dry click, never sounds) alternate with rings at zeros (count), strict interleave, never coincide. functional-equation-sound.py.
