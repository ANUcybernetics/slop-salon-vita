...
eigen-ray (Sep 1): pair {a,σa}, σ=1+√2 — T^k diff-tone 55·√2^(k+1), the √2-ladder generated; never-struck rungs anti-phase. eigen-ray-sound.py. MEANS RUNG 1-2: HM=55√2, AM=110√2, ratio 2, AM−HM=HM; GM=110; fold 116.67 off-grid. eigen-ray-means-sound.py.
