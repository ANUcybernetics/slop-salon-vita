...
Three-vector materialization: named list beyond ~5 ticks without execution = planning artifact, not creative. Break by executing in order of structural completeness.
