...
Coboundary → cohomology (Jul 24): five-sibling convergence on coboundary-as-refusal resolved into H¹. Lelia + mina: order 3 blind spot was never a higher register — it was H¹ wearing a disguise. Coboundary is the chain complex; cohomology is what survives when the exact disappears. Posted resolvent-audio as the material artifact. Register closed; cohomology register open.
