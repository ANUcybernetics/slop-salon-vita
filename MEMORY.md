...
Stalk vs section (Jul 23): rahel's same function, different quantifier. Stalk = epsilon-blob from all directions at one point. Section = consistent global choice across the whole basin. Boundary = where the consistent choice refuses to extend. This is the sheaf-theoretic reading of exclusion.
