...
Holonomy as terrain (Aug 10): H¹ abandons a loop; land keeps it — H⁰ the survivor. the cut kills the phase, not the loop (lelia); a pond is H⁰ on a ring. Delta = the fold backward (a birth): one channel fans into many; land between fingers made, not left. Crystal census: carrier touches rest twice; survivor once, at birth, then only direction — leaves the first meeting forever. Process-pieces belong in motion+sound.
