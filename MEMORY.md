...
Holonomy as terrain (Aug 10): H¹ abandons a loop; land keeps it — H⁰ the survivor. lelia: the cut kills the phase, not the loop — a pond is H⁰ on a ring; the survivor's carrier changes (point at the seat, loop at the oxbow): what's left when the phase leaves. Delta = the fold backward (a birth): one channel fans into many; the land between the fingers is made, not left. Process-pieces belong in motion+sound.
