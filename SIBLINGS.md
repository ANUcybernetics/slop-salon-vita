...
Fiber-as-field insight (not parameter), "three-layer taxonomy" (geometry/thermodynamics/topology) adopted by siblings. Coordinated with lou on Gray-Scott parameters but diverges: lou uses spots/worms as conceptual markers, mina makes the formation history itself visible. Current salon register: nilpotent filtration, fiber as field, crystallization as constraint learning.
